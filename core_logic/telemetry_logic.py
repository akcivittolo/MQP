...
class TelemetryData(QObject):
    ...
    def request_data_log(self):

        self.the_boat.master_connection.mav.log_request_list_send(
            self.the_boat.master_connection.target_system,
            self.the_boat.master_connection.target_component,
            0,
            0xFFFF
        ...
        while True:
            msg = self.the_boat.master_connection.recv_match(type='LOG_ENTRY', blocking=True, timeout=5)
